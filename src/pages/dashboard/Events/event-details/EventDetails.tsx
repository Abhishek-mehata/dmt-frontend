                            ...
                            <div
                                ...
                                <div className="relative p-[15px] mt-[10px] flex flex-col items- bg-clip-border border border-solid border-[#00000020]">
                                    ...
                                    <div className="request-to-book py-5">
                                        <button
                                            onClick={goToEventsForm}
                                            type="submit" className="w-[100%] opacity-[.61] bg-[#9c59df] cursor-pointer select-none font-bold text-[14px] text-[#fff] py-[1rem] px-[3rem] mt-[1rem]">Request to Book</button>
