...
const TypeAndLocation = () => {
    return (
        <>
            <div>
                {/* Event Type Here */}
                <h2 className="text-[28px] text-center xs:text-left font-medium text-[#172b4d]">ONSITE EVENT</h2>
                {/* Event Location Here*/}
                <div className="flex">
                    <img className="w-20px mr-[5px]" src={locationImg} alt="" />
                    <span className="font-medium text-[#8b9199] text-[17px]">Kathmandu 44600, Nepal</span>
                </div>
            </div>
