...
//       <div className=" h-[270vh] z-50 w-full md:px-16 absolute top-36 left-7 md:top-[1020px] lg:top-[600px] flex justify-between mt-6 ">
//         {/* lines & buttons---- */}
...
//         <div
//           ref={ref}
//           className="hidden lg:block max-w-[400px] mt-7 pt-5 sticky top-[140px] z-10 w-[30%]
...
//         <div
//           ref={ref2}
//           className=" hidden sticky top-[140px] max-w-[350px] mt-7 pt-5 z-10 w-[30%] mr-5
